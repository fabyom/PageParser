...
from Parser_WiTTFind.Parser_OCR import AltoParser
...
def main():
    ...
    # document_id = "Ms-114"
    # alto_path = "C:/Users/Katharina/PycharmProjects/WiTTFind/Ms-114/alto"
    # json_path = "C:/Users/Katharina/PycharmProjects/WiTTFind/Ms-114/test_output.json"

    # Actual arguments when calling from command line
    alto_path, document_id, json_path = handle_args()

    parser = AltoParser(alto_path, document_id)
    parser.read_files()
